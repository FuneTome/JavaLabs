...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        btnAdd.setOnAction(e -> items.add(new Table(field1.getText(), field2.getText(), field3.getText())));
        ...
        VBox buttonBox = new VBox(10, btnAdd, btnDel, btnCalc);
        buttonBox.setPadding(new Insets(0, 0, 0, 20));

        VBox labelBox = new VBox(20, label1, label2, label3);
