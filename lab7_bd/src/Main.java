...
public class Main extends Application {
    ...
    public static class Table {
        ...
        public static RecIntegral tableToRec (Table t){
            return new RecIntegral(t.getLowerLimit(), t.getUpperLimit(), t.getSteps(), t.getResult());
        }
    }
    ...
    public void start(Stage primaryStage) {
        ...
        btnAdd.setOnAction(e -> {
            try{
                if (field1.getText().isBlank() || field2.getText().isBlank() || field3.getText().isBlank()) {
                    ...
                    RecIntegral ri = new RecIntegral(id++, Double.parseDouble(field1.getText()),
                            Double.parseDouble(field2.getText()),
                            Double.parseDouble(field3.getText()));
                    recIntegral.add(ri);
                    DatabaseManager.addRecord(ri);
                    items.add(DatabaseManager.getLastRecords().getTable());
                }
        ...
        btnDel.setOnAction(e -> {
            ...
            DatabaseManager.removeRecord(recIntegral.get(index));
        ...
        btnCalc.setOnAction(e -> {
            ...
            DatabaseManager.updateRecord(recIntegral.get(index));
        ...
        btnFill.setOnAction(e -> {
            items.clear();
            List<RecIntegral> list = DatabaseManager.getRecords();
                    ...
                    while ((line = reader.readLine()) != null) {
                        ...
                        if (parts.length >= 4) {
                            try {
                                ...
                                RecIntegral ri = new RecIntegral(lower, upper, step,  result);
                                recIntegral.add(ri);
                                DatabaseManager.addRecord(ri);
                                items.add(DatabaseManager.getLastRecords().getTable());
